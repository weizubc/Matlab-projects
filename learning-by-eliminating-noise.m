    ...
    for i=1:2:(n-1)
        ...
        if favorite(agent_1)==1
            ...
            if favorite(agent_1)==2
                ...
                if agent(agent_2).goods(1,t)==1 && agent(agent_1).goods(1,t)~=1
                    lamda_1=1;
                end
            end

            if favorite(agent_1)==3
                lamda_1=0;
                if agent(agent_2).goods(1,t)==3
                    lamda_1=1;
                end
            end
        end
        ...
        if favorite(agent_2)==1
            ...
            if favorite(agent_2)==2
                ...
                if agent(agent_1).goods(1,t)==1 && agent(agent_2).goods(1,t)~=1
                    lamda_2=1;
                end
            end

            if favorite(agent_2)==3
                lamda_2=0;
                if agent(agent_1).goods(1,t)==3
                    lamda_2=1;
                end
            end
        end
